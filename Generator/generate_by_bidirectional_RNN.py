...
import sys
from Generator.text_processor import process
...
data = process(data_path, 'none', False, True)
...
count_words(word_counts, subject_lines)
count_words(word_counts, email_bodies)
